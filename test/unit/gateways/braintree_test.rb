...
class BraintreeTest < Test::Unit::TestCase
  ...
  def test_add_address
    ...
    assert_equal ["address1", "country", "state"], result.stringify_keys.keys.sort
  ...
  def test_add_shipping_address
    ...
    assert_equal ["shipping_address1", "shipping_country", "shipping_state"], result.stringify_keys.keys.sort
